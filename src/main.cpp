...
uint256 hashGenesisBlock("0xc4d6d5e0f348e70e296cccdfc9badfffeb99ec5015c16d89b18f56b769b70134");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Egyptcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Egyptcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 4 * 60 * 60; // Egyptcoin: 240 minutes (Litecoin: 3.5 days)
static const int64 nTargetSpacing = 60; // Egyptcoin: 6 seconds (~1/4x Litecoin: 2.5 minutes)
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // Egyptcoin: 240 blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal egyptcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Egyptcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
		...
		//   CTransaction(hash=730f0c8ddc, ver=2, vin.size=1, vout.size=1, nLockTime=0, strTxComment=text:Egyptcoin genesis block)
        ...
        // Genesis block
        const char* pszTimestamp = "Egypt, blessing from God.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		txNew.strTxComment = "text:Egyptcoin genesis block";
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1377457970;
        ...
        assert(block.hashMerkleRoot == uint256("0x208ff9bf424998631e524b4314355300a6b6c66d711434e36f286b14a74b3393"));
